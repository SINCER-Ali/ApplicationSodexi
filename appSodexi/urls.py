...
from .views.import_cyd40 import import_cyd40
...
urlpatterns = [
    ...
    path('visuamiser_cyd40/', visualiser_cyd40, name='visualiser_cyd40'),
    path('profil/', profil, name='profil'),
    path('import_cyd40/', import_cyd40, name='import_cyd40'),
